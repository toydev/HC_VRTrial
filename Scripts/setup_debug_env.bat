...
REM ========== Data
REM DLL files
COPY "%HC_VRTrial_SOLUTION_DIR%\SteamVRLib_Unity.XR.OpenXR\x64\UnityOpenXR.dll" "%HC_VRTrial_GAME_DATA_DIR%\Plugins\x86_64"
...
MKDIR "%HC_VRTrial_GAME_DATA_DIR%\UnitySubsystems\UnityOpenXR"
COPY "%HC_VRTrial_SOLUTION_DIR%\SteamVRLib_Unity.XR.OpenXR\UnitySubsystemsManifest.json" "%HC_VRTrial_GAME_DATA_DIR%\UnitySubsystems\UnityOpenXR"
