...
namespace UnityEngine.XR.OpenXR
{
    ...
    public partial class OpenXRLoaderBase : XRLoaderHelper
    {
        ...
        private static List<IntegratedSubsystemDescriptor> s_DisplaySubsystemDescriptors =
            new List<IntegratedSubsystemDescriptor>();
        private static List<IntegratedSubsystemDescriptor> s_InputSubsystemDescriptors =
            new List<IntegratedSubsystemDescriptor>();
